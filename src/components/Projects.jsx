        ...
        <>
            ...
            >
                <div className="max-w-6xl mx-auto px-5">
                    {/* SECTION TITLE */}
                    <h2 className="text-4xl md:text-5xl font-extrabold mb-14 text-neutral-900 dark:text-white">
                        Featured <span className="text-teal-400">Projects</span>
                    </h2>
                    {/* FEATURED PROJECT */}
                    <div className="mb-16 reveal" data-reveal>
                        <div className="group grid md:grid-cols-2 rounded-3xl overflow-hidden border border-neutral-200 dark:border-neutral-800
                      ...
                      transition-transform duration-500 group-hover:scale-105" loading="lazy" />
                                {/* Hover Overlay */}
                                <div className="absolute inset-0 bg-black/60 dark:bg-black/60 opacity-0 group-hover:opacity-100 
...
h-full flex flex-col shadow-md">
      ...
      text-neutral-600 dark:text-neutral-400 mb-3">
                                        <strong>Problem:</strong> Managing product data dynamically on the
                                        client side required an interactive interface that could handle
                                        updates without page reloads.
                                        <br /><br />
                                        <strong>My Role:</strong> Built an interactive web application using
                                        JavaScript to handle dynamic DOM updates, event handling, and
                                        client-side product sorting functionality.
                                        <br /><br />
                                        <strong>Result:</strong> Created a smooth, user-friendly experience
                                        that allows users to manage and organize product data efficiently
                                        in real time.
                                    </p>
...
transition flex items-center justify-center">
                                ...
                                <div className="p-5 flex flex-col grow">
                                    ...
                                    <div className="mt-auto flex flex-wrap items-center justify-between gap-4">
                                        <div className="flex flex-wrap gap-3 text-xs text-neutral-900 dark:text-white/80">
                                            <span className="flex items-center gap-1">
                                                <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" className="w-4" loading="lazy" alt="html5" />
                                                HTML5
                                            </span>
